...
bucket = "terraform.bandenkop.store"
}
...
name = "terraform-bandenkop-store-oac"
description = "OAC for terraform.bandenkop.store S3 bucket access"
...
aliases = ["terraform.bandenkop.store"]
origin {
origin_id = "S3-terraform.bandenkop.store"
...
target_origin_id = "S3-terraform.bandenkop.store"
